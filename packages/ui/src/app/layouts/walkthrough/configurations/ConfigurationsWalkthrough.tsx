    ...
    return (
        <Box>
            <Box px={20}>
                ...
                <Text fz='md' mt={20}>
                    Congratulations, you have completed the Gator Server setup! Here are some useful features that
                    you may want to checkout to customize your Gator experience!
                </Text>
